...
public interface ICartRepository
{
    ...
    Task<Return<CartItem>> GetCartItemByProductIdAndUserId(Guid productId, Guid userId);
    ...
    Task<Return<bool>> AddToCart(CartItem cartItem);
    Task<Return<bool>> SyncCart(List<CartItem> carts);
    Task<Return<bool>> UpdateCartItem(CartItem cartItem);
