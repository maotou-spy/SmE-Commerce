...
) : IDiscountService
{
    ...
    public async Task<Return<bool>> UpdateDiscountAsync(Guid id, UpdateDiscountReqDto req)
    {
        ...
        try
        {
            ...
            discount.Data.ModifiedById = currentUser.Data.Username;
        ...
        try
        {
            ...
            if (discountCodes.Data != null && discountCodes.Data.Any())
                foreach (var discountCode in discountCodes.Data)
                {
                    ...
                    discountCode.ModifiedById = currentUser.Data.Username;
    ...
    )
    {
        try
        {
            ...
            discountCode.Data.ModifiedById = currentUser.Data.Username;
