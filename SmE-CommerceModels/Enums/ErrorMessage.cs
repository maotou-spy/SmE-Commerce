...
public static class ErrorMessage
{
    ...
    public const string DiscountNotFound = $"Order {NotFound}";
    ...
    public const string NameAlreadyExists = $"Name {AlreadyExists}";
    ...
    public const string InvalidDiscountCode = "Invalid discount code";
    ...
    // Not For Customer
    public const string NotForCustomer = "Not For Customer";
